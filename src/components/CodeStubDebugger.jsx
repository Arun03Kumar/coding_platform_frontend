...
import { updateCodeStubForLanguage, setCurrentCodeStubLanguage } from '@/store/createProblemSlice';
...
export default function CodeStubDebugger() {
  ...
  const handleUpdate = () => {
    dispatch(updateCodeStubForLanguage({
    ...
    <div className="p-4 border rounded">
      ...
      <div className="mb-4">
        ...
        <div className="flex gap-2 mt-2">
          <button className="px-2 py-1 bg-blue-500 text-white rounded" onClick={() => handleLanguageChange('JAVA')}>Java</button>
          <button className="px-2 py-1 bg-green-500 text-white rounded" onClick={() => handleLanguageChange('PYTHON')}>Python</button>
          <button className="px-2 py-1 bg-red-500 text-white rounded" onClick={() => handleLanguageChange('CPP')}>C++</button>
        </div>
      </div>
      ...
      <div className="mb-4">
        ...
        />
        <button onClick={handleUpdate} className="ml-2 px-2 py-1 bg-purple-500 text-white rounded">
